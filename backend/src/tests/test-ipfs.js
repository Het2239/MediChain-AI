...
async function runTests() {
    try {
        ...
        try {
            ...
            console.log('\n⚠️  Please configure Pinata credentials in .env:');
    ...
    `.trim();
        ...
        console.log('\n1️⃣1️⃣  Cleanup Test File...');
        console.log(`   ⚠️  Test file will remain pinned on IPFS`);
        console.log(`   ℹ️  To delete, uncomment the cleanup code in test script`);
        console.log(`   ℹ️  CID to delete: ${uploadedCID}`);
